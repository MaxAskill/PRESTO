...
<head>
    <title>WH c/o Supervisor Letter</title>
    <meta charset="utf-8">
...
if($company == "NBFI"){
    ...
    <p>Subject: <b>PULL-OUT</b> </p><br><br>


    <p>Dear Sir/Ma'am:</p>
    <p>We hereby authorize our representative, <pan style="text-transform: uppercase; font-weight: bold; text-decoration: underline;">{{ $name }}</pan>, and the office representative (whose name is listed below) to pull out specific stocks from your store in sealed boxes between <span id="formattedDate"></span> {{ $dateStart }}, and {{ $dateEnd }}.</p><br>

        <div class="mx-24">
            <table id="branchMaintenanceTable" class="w-full text-xs text-left text-gray-500 dark:text-gray-400 border border-slate-800">
