...
<head>
    <title>Chain Distribution Center Letter</title>
    <meta charset="utf-8">
...
if($company == "NBFI"){
    ...
    <!-- Message -->
    <p>Dear Sir/Ma'am:</p>
    <p>This is to authorize our representative and/or accredited service representative, <pan style="text-transform: uppercase; font-weight: bold; text-decoration: underline;">{{ $name }}</pan>, to  pull out specific stocks in your store in sealed cartons between  <span id="formattedDate"></span> {{ $dateStart }}, and {{ $dateEnd }}.</p><br>
