...
<head>
<?php 
    echo $transactionType == "CPO Back to WH c/o Supervisor" ?  '<title>Pull-Out Letter</title>' :  '<title>Item Disposal Letter</title>';
    ?>
...
if($company == "NBFI"){
    ...
    <p>Subject: <b>PULL OUT FOR ITEM DISPOSAL</b> </p>
        <!-- <strong><?php 
    echo $transactionType == "CPO Back to WH c/o Supervisor" ?  'PULL-OUT LETTER ' :  'ITEM DISPOSAL LETTER ';
    ?></strong> -->
    ...
    <p>This is to authorize our representative, <pan style="text-transform: uppercase; font-weight: bold; text-decoration: underline;">{{ $name }}</pan>, to request disposal of the damaged stocks stated below.</p><br>
        ...
        <div style="border: 1px solid blue; margin-left: 5%; margin-right: 5%; padding: 5px; font-style: italic; font-size: 12px">
        <p>NOTE: These items are requested to be destroyed and disposed of by authorized store personnel. The disposal items do not need to be returned to the head office. Kindly furnish us with a copy of the gate pass to confirm actual disposal.</p><br>
