        ...
        <card>
          ...
          <tabs value="Description" tab-content-classes="text-center">
            <tab-pane title="Home" key="home">
              ...
              <p>
                It’s one continuous form where hardware and software function in perfect
                unison, creating a new generation of phone that’s better by any measure.
              </p>
            </tab-pane>
        ...
        <card type="plain" class="card-subcategories">
          ...
          <tabs pills type="primary" icons centered tab-content-classes="tab-space">
            <tab-pane id="home" key="home">
              <span slot="title"> <i class="nc-icon nc-umbrella-13"></i> Home </span>
            ...
            <tab-pane id="messages" key="messages">
              <span slot="title"> <i class="nc-icon nc-shop"></i> Messages </span>
            ...
            <tab-pane id="settings" key="settings">
              <span slot="title"> <i class="nc-icon nc-settings"></i> Settings </span>
